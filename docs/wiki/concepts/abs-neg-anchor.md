...
_See textbook excerpt below or [`tasks/abs-neg-anchor/`](../../../tasks/abs-neg-anchor/) if available._

## Bach's textbook treatment

# Bach textbook excerpt — |-x| = |x|

**Concept ID:** `abs-neg-anchor`
**Chapter:** Ch 1
...
- Standard absolute-value symmetry used implicitly throughout.
...
- Lean target: forward the corresponding Mathlib lemma (`abs_neg`).
...
- **Theorem/def name:** `abs_neg_anchor`
- **Status:** (unaudited)
