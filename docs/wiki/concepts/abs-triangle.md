...
_See textbook excerpt below or [`tasks/abs-triangle/`](../../../tasks/abs-triangle/) if available._

## Bach's textbook treatment

# Bach textbook excerpt — Absolute-value triangle inequality

**Concept ID:** `abs-triangle`
**Chapter:** Ch 1
...
- Bach uses the triangle inequality throughout — e.g., in the bounded-variation hypothesis of McDiarmid (Proposition 1.3, page 13), in martingale-difference arguments, etc. Standard real-analysis prerequisite.
...
- Lean target: forward the corresponding Mathlib lemma (`abs_add`).
