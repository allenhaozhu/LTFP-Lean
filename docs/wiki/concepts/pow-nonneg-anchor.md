# x^n ≥ 0 from nonneg base

**ID:** `pow-nonneg-anchor`  
...
_See textbook excerpt below or [`tasks/pow-nonneg-anchor/`](../../../tasks/pow-nonneg-anchor/) if available._

## Bach's textbook treatment

# Bach textbook excerpt — x^n ≥ 0 from nonneg base

**Concept ID:** `pow-nonneg-anchor`
**Chapter:** Ch 1
...
- Bach uses pow nonneg implicitly throughout. Standard ordered-ring fact.
...
- Lean target: forward the corresponding Mathlib lemma (`pow_nonneg`).
...
- **Theorem/def name:** `pow_nonneg_anchor`
- **Status:** (unaudited)
