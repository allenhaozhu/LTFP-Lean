...
_See textbook excerpt below or [`tasks/abs-nonneg-anchor/`](../../../tasks/abs-nonneg-anchor/) if available._

## Bach's textbook treatment

# Bach textbook excerpt — |x| ≥ 0

**Concept ID:** `abs-nonneg-anchor`
**Chapter:** Ch 1
...
- Standard absolute-value nonnegativity used implicitly throughout — e.g., in the bounded-variation hypothesis of McDiarmid (page 13).
...
- Lean target: forward the corresponding Mathlib lemma (`abs_nonneg`).
...
- **Theorem/def name:** `abs_nonneg_anchor`
- **Status:** (unaudited)
