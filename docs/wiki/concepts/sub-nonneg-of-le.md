...
_See textbook excerpt below or [`tasks/sub-nonneg-of-le/`](../../../tasks/sub-nonneg-of-le/) if available._

## Bach's textbook treatment

# Bach textbook excerpt — 0 ≤ b - a from a ≤ b

**Concept ID:** `sub-nonneg-of-le`
**Chapter:** Ch 1
...
- Standard ordered-ring fact used implicitly throughout.
...
- Lean target: forward the corresponding Mathlib lemma (`sub_nonneg.mpr`).
...
- **Theorem/def name:** `sub_nonneg_of_le`
- **Status:** (unaudited)
