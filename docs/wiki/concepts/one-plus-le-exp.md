...
_See textbook excerpt below or [`tasks/one-plus-le-exp/`](../../../tasks/one-plus-le-exp/) if available._

## Bach's textbook treatment

# Bach textbook excerpt — 1 + α ≤ exp α (alias)

**Concept ID:** `one-plus-le-exp`
**Chapter:** Ch 1
...
- Bach uses the inequality 1 + α ≤ exp α implicitly when bounding cumulant generating functions. It is the first-order Taylor bound for exp, a standard real-analysis fact.
...
- **Theorem/def name:** `one_plus_le_exp`
- **Status:** (unaudited)
