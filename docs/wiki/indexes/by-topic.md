...
Concepts grouped by coarse keyword-based topic tag. One concept can appear under multiple tags. **Untagged** lists concepts that didn't match any rule (~chapter-specific internals).

## PAC-Bayes — 7 concepts
